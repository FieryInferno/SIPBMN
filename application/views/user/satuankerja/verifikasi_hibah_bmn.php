				...
				<?php
					...
					foreach ($phbmn as $key) { ?>
						<tr>
							...
							<td>Surat Permohonan Hibah BMN</td>
						...
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Surat Pernyataan Hibah Tidak Mengganggu Tugas Pokok dan Fungsi</td>
							<td><a href="<?= base_url(); ?>assets/spbmn/<?= $key->pdf10; ?>"><?php echo $key->pdf10 ?></a></td>
							<td><p align="center"><input type="checkbox" name=""></p></td>
						</tr>
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Dokumen Penganggaran BMN</td>
							<td><a href="<?= base_url(); ?>assets/spbmn/<?= $key->pdf11; ?>"><?php echo $key->pdf11 ?></a></td>
							<td><p align="center"><input type="checkbox" name=""></p></td>
						</tr>
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
