      ...
      <?php
					...
					foreach ($phbmn as $key) { ?>
						<tr>
							...
							<td>Surat Permohonan Pemusnahan BMN</td>
						...
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Penjelasan dan pertimbangan pemusnahan BMN</td>
						...
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Surat penyataan bahwa BMN tidak lagi dapat digunakan, dimanfaatkan, dan/atau dipindahtangankan atau BMN harus dilakukan pemusnahan berdasarkan ketentuan peraturan perundang-undangan</td>
							<td><a href="<?= base_url(); ?>assets/spbmn/<?= $key->pdf7; ?>"><?php echo $key->pdf7 ?></a></td>
							<td><p align="center"><input type="checkbox" name=""></p></td>
						</tr>
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Foto asli BMN yang diusulkan dimusnahkan</td>
							<td><a href="<?= base_url(); ?>assets/spbmn/<?= $key->pdf8; ?>"><?php echo $key->pdf8 ?></a></td>
							<td><p align="center"><input type="checkbox" name=""></p></td>
						</tr>
						<tr>
							<td><p align="center"><?= $no++; ?></p></td>
							<td>Surat Pernyataan Pemusnahan Tidak Mengganggu Tugas Pokok dan Fungsi</td>
