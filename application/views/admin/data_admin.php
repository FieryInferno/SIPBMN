...
<p>
	<a href="#" class="btn btn-mini"><i class="icon-lock"></i> Management Data Admin</a>&nbsp;
	<a href="<?php echo base_url()."index.php/Admin/Admin/peraturan_admin"; ?>" class="btn btn-mini"><i class="icon-wrench"></i> Peraturan</a>&nbsp;
</p>
	...
	<tbody>
	 ...
	 foreach($data as $d) { ?>
		<tr class="nowrap">
			...
			<td><a href="<?php echo base_url()."index.php/Admin/Admin/edit_admin/".$d['username'];?>" class="btn btn-mini"><i class="icon-edit"></i> Edit</a>
			<td><a href="<?php echo base_url()."index.php/Admin/Admin/hapus_admin/".$d['username'];?>" class="btn btn-mini" onClick="return confirm('Delete admin dengan ID : <?php echo $d['username'];?>');"><i class="icon-trash"></i> Delete</a></td>
			<?php } ?>
