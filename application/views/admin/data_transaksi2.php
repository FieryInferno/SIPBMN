...
echo "</td>
	  ...
	  <td class='td-data'><a href='".base_url().'index.php/Admin/Admin/perpanjang_action/'.$d['id_transaksi'].'/'.$d['id_buku'].'/'.$lambat.'/'.$tgl_dateline."'><i class='btn btn-mini'>Perpanjang&nbsp;<i class='icon-plus-sign'></i></i></a></td>
	  </tr>";
}
?>
</tbody>
...
<a href="<?php echo base_url()."index.php/Admin/Admin/pdf_data_transaksi"; ?>" class="btn btn-mini"><i class="icon-print"></i> Print</a>&nbsp;<a href="<?php echo base_url()."index.php/Admin/Admin/transaksi"; ?>" class="btn btn-mini"><i class="icon-th-large"></i> Transaksi</a>
<br>
<br>
