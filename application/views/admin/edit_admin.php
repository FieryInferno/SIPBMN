...
<div id="wrapper">
<div class="page-header"><h3><img src="<?php echo base_url(); ?>assets/img/pensil.png" width="50" height="50" /> Edit Data Mahasiswa Perpustakaan - Admin</div>
</div>
...
<legend>Formulir Edit Data Mahasiswa Polsub</legend>
    ...
    <form action="<?php echo base_url()."index.php/Admin/Admin/do_edit"; ?>" method="post">
