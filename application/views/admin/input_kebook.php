...
<?php } ?>
    ...
    <div style="text-align:justify;"><img src="<?php echo base_url(); ?>assets/img/rar.png" width="50" height="50" style="float:left; margin:0 9px 3px 0;" /><legend>Upload Kumpulan File Ebook RAR/ZIP</legend></h3>
    <form name="form" enctype="multipart/form-data" action="<?php echo base_url()."index.php/Admin/Admin/do_input_kebook"; ?>" method="POST">
    <p>Judul<br />
    ...
    <p>Ukuran File Maksimal : 100 MB. <br />
    <input type="hidden" name="jenis" value="Kumpulan Ebook" />
