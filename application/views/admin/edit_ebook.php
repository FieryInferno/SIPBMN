...
<?php } ?>
    ...
    <form name="form" enctype="multipart/form-data" action="<?php echo base_url()."index.php/Admin/Admin/do_edit_ebook"; ?>" method="POST">
    <p>Judul<br />
    <input type="text" name="judul" value="<?php echo $judul; ?>"/>
		<p>
			...
			<option value="Hukum" <?php if($kategori == 'Hukum'){ echo 'selected'; } ?>>Bidang Hukum</option>
			<option value="Teknik" <?php if($kategori == 'Teknik'){ echo 'selected'; } ?>>Bidang Teknik</option>
			<option value="Ekonomi" <?php if($kategori == 'Ekonomi'){ echo 'selected'; } ?>>Bidang Ekonomi</option>
			<option value="PAI" <?php if($kategori == 'PAI'){ echo 'selected'; } ?>>Bidang Agama Islam</option>
			<option value="Komputer" <?php if($kategori == 'Komputer'){ echo 'selected'; } ?>>Bidang Ilmu Komputer</option>
			<option value="Sosial" <?php if($kategori == 'Sosial'){ echo 'selected'; } ?>>Bidang Ilmu Sosial dan Ilmu Politik</option>
			<option value="Pendidikan" <?php if($kategori == 'Pendidikan'){ echo 'selected'; } ?>>Bidang Keguruan dan Ilmu Pendidikan</option>
			<option value="Pertanian" <?php if($kategori == 'Pertanian'){ echo 'selected'; } ?>>Bidang Pertanian</option>
			</select>

		</p>
    <p>Ukuran File Maksimal : 50 MB. <br /> 
    <input type="hidden" name="jenis" value="Ebook" />
    Pilih File : <input type="file" name="berkas" id="berkas" value="<?php echo set_value('berkas'); ?>" size="20" /><br><br>
