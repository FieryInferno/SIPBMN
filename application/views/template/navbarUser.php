    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h3>
                    <img src="<?php echo base_url(); ?>assets/img/book1.png" width="50" height="50" /> 
                    <a class="font1">Sistem Informasi Pengelolaan Barang Milik Negara</a>
                    <small><b class="font2"></b></small>
                </h3>
            </div>
